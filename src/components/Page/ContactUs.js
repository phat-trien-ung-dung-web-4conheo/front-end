    ...
    return (
        ...
        <Container className="relative">
             <Contact>
                ...
                <div className="laptop:bg-black mobile:bg-white tablet:bg-white absolute top-0 left-0 right-0 bottom-0 opacity-70"> 
                </div>
            </Contact>
                <div className='absolute z-99 top-0 laptop:p-4 mobile:p-0 tablet:p-0 right-0 left-0 text-center'>
                    <h1 className='laptop:text-white mobile:text-indigo-900 text-lg font-semibold'>CONTACT US</h1>
           ...
           <Information>
                    <div class="laptop:flex laptop:gap-3 mt-10 laptop:justify-center laptop:items-start laptop:flex-row-reverse">
                        <div class="px-6 py-10 laptop:opacity-80 flex flex-col laptop:rounded-tr-3xl laptop:rounded-bl-3xl latop:shadow-lg w-[400px] tablet:w-full mobile:w-full" style={{backgroundColor: "#4d4b8b"}} >
                        ...
                        <div className="laptop:pt-14 laptop:pb-10 px-5 py-10 laptop:opacity-80 laptop:rounded-tr-3xl laptop:rounded-bl-3xl laptop:shadow-lg laptop:w-[400px]
                        tablet:w-full mobile:w-full tablet:bg-white mobile:bg-white" style={{backgroundColor: "#2d284a"}}>
                            <button className=" text-white">
                                <h3 className="text-left text-lg mobile:text-indigo-900 tablet:text-indigo-900 mobile:tablet:uppercase ">Contact information</h3>
                                <div className="border-b pt-5 pb-2 "></div>
                                    <div className="flex gap-3 items-center pt-5 pb-2">
                                        <LocationOnIcon className="rounded-full bg-slate-600 p-1 h-7 fill-white"></LocationOnIcon>
                                    ...
                                    <div className="flex gap-3 items-center pt-5 pb-2">
                                        ...
                                        <p className=" text-gray-500 text-sm">
                                            <span className="text-white text-base">Telephone number: </span>
                                            0847.635.644
                                        </p>
                                    </div>
                                    <div className="flex gap-3 items-center pt-5 pb-2">
                                    ...
                                    <div className="flex gap-3 items-center pt-5 pb-2">
                                        ...
                                        <p className=" text-gray-500 text-sm">
                                            <span className="text-white text-base">Website: </span>
                                            https://www.app.com
                                        </p>
                                    </div>
                            </button>
            ...
            <div className="laptop:absolute laptop:pt-16 laptop:pb-40 laptop:px-48 laptop:right-0 laptop:left-0 bg-white">
                <h3 className="text-center text-lg font-semibold" style={{color:"#2a254b"}}>See what our customers are saying about us</h3>
                <div className="laptop:flex laptop:gap-5 laptop:items-start laptop:mt-16 laptop:pb-40">
                 ...
                 <div className="absolute laptop:pt-16 laptop:px-48 laptop:pb-40 right-0 left-0 bg-gray-100">
                    ...
                    <div className="absolute py-10 mt-20 text-center left-0 right-0 bg-white">
